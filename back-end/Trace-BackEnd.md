...
俏香阁,0.657777778,53,100012901812,35
十月稻田,0.71875,61,4292944,13.8
华源良品,0.666666667,38,10020176668539,31.2
南国,0.75,71,623760,21.9
厨邦,0.760747664,186,3763759,5.9
吉香居,0.695163105,230,4665497,8.8
地道湘,0.59602649,59,30750526915,29.8
大嘴先生,0.745098039,138,100015687534,13.8
娃哈哈,0.787592008,261,1129090,48
川南,0.726244344,219,100000428823,13.9
川娃子,0.741672332,484,100005264233,12.8
川珍,0.721518987,47,100010637500,11.8
方家铺子,0.765676568,198,5415987,15.9
春光,0.695767196,137,5676502,5.5
李子柒,0.64781491,109,10024090168114,34.9
李锦记,0.754975124,307,1078121,16.9
汴都铺子,0.74301676,38,29438929692,79
泰奇,0.737603306,151,7552427,66
海天,0.756351039,250,1338357,12.9
海底捞,0.72280419,404,100002398567,18.9
清净园,0.733333333,225,100007770057,18.9
燕之坊,0.717153285,77,2804958,13.8
特瑞肯,0.755067568,206,5964486,19.9
珍尚米,0.718972896,231,100008762408,46.8
禾煜,0.834437086,42,100000977790,28.7
老坛子,0.767741935,113,100006982973,22.8
老干妈,0.747146933,687,844099,9.9
聪厨,0.805781391,280,100008050179,14.9
茂德公,0.725619835,253,6644451,15.8
虎邦,0.728413284,415,4410290,18.8
蜀姑娘,0.691287879,184,8922029,13.9
谷小宝,0.739903069,108,100016415708,29.9
达利园,0.71760633,385,705816,32.9
酱先生,0.691099476,130,100015856592,14.9
银鹭,0.678090575,95,7585104,34.9
韩今,0.707142857,115,3681877,32.9
饭扫光,0.734177215,135,100015029096,12.6
鹃城牌,0.707100592,171,3798578,10.9
```
...
使用差分整合移动平均自回归模型（**ARIMA**）进行时间序列预测。通过对前三年向量数据进行差分整合并用于模型训练，最终可以通过训练好的模型对下一年的销量进行预测。
...
预测出2021年的销量，并将2021年与前三年的时间与销量数据存储在MongoDB数据库中，返回前端进行折线图展示。

**折线图存储示例**

在 MongoDB 的trace数据库中，名为“predict”的collection中存储

```
{
        "_id" : ObjectId("6034736e9f236667438db7dc"),
        "company_name" : "老干妈",
        "date" : [
                "2018-01-01",
                "2018-02-01",
...
{
        "_id" : ObjectId("6034736e9f236667438db7dd"),
        "company_name" : "泰奇食品",
        "date" : [
                "2018-01-01",
                "2018-02-01",
