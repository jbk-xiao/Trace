    ...
    <div>
        <div class="page-wrapper">
            ...
            <div class="list">
                ...
                <Trace :pname='goodinfo' url='http://121.46.19.26:8511/getAllTraceInfo/440108400003939/' cid='440108400003939'></Trace>
            </div>
...
<script>
    ...
    import Trace from '@/components/TraceabilityInfo2.vue'*/
    ...
    export default {
        ...
        components: {
            ...
            GoodsList:() => import('@/components/GoodsList2.vue'),
        ...
        methods: {
            ...
            async getInfo() {
                ...
                let ginfo = await axios.get("http://121.46.19.26:8511/getProducts/440108400003939")
                this.goodinfo=ginfo.data

                // let tinfo = await axios.get("data/goods_list0.1.json")
                // this.traceinfo = tinfo.data

                //let pinfo = await axios.get("http://121.46.19.26:8511/getProducts/440108400003939")
