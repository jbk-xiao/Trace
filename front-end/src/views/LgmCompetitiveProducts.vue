        ...
        <div class="page-wrapper">
            ...
            <section class="project-details">
                ...
                <el-row :gutter="6">
                    ...
                    <el-col :span="12" class="col-sm-12 col-md-8 col-lg-6">
                ...
                <el-row :gutter="6">
                    ...
                    <el-col :span="8" class="col-sm-12 col-md-6 col-lg-4">
                        <section class="project-details">
                            ...
                            <DGraph :info='tinfo' :key="keyd"></DGraph>
                        </section>
                    </el-col>
                </el-row>
...
<script>
    ...
    import CompetitiveList from '@/components/CompetitiveCompanies.vue'
    ...
    //import LgmRelation from '@/components/LgmRelation.vue'
    export default {
        name: 'CPs',
        components: {
            ...
            CompetitiveList: () => import('@/components/CompetitiveCompanies.vue'),
            //Radar:resolve => {require(['@/components/Radar.vue'], resolve)},
        ...
        methods: {
            ...
            async getInfo() {
                ...
                let threeInfo = await axios.get("http://121.46.19.26:8511/get3dScore/844099") //3d图数据
                let commentInfo = await axios.get("http://121.46.19.26:8511/getCommentStatistic/844099")
                let saleInfo = await axios.get("http://121.46.19.26:8511/getPredict/" + "老干妈") //销量+预测数据
                let qpInfo = await axios.get("http://121.46.19.26:8511/getRelateSearch/" + "老干妈") //关联搜索气泡图数据
                let siInfo = await axios.get("http://121.46.19.26:8511/getIndexPredict/" + "老干妈") //搜索指数数据
                let ageInfo = await axios.get("http://121.46.19.26:8511/getAgeDistribution/" + "老干妈") //搜索指数数据
                let regInfo = await axios.get("http://121.46.19.26:8511/getProvinceIndex/" + "老干妈") //地区搜索指数数据
                let newsInfo = await axios.get("http://121.46.19.26:8511/getNews/" + "老干妈") //新闻数据
                
                let treeInfo = await axios.get("http://121.46.19.26:8511/getEmotionAnalysis/"+"老干妈") //树图数据                
                let {
                    data
                } = await axios.get(
