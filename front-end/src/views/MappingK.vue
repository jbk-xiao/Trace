        ...
        <div class="page-wrapper">
            ...
            <section class="project-details">
                <div class="text-center more-btn__box">
                    <span class="thm-btn">品类竞争图谱</span>
                </div><br>
            <KindRelation :jsonObj="info"></KindRelation>
            </section>
...
<script>
    ...
    import KindRelation from '@/components/KindRelation.vue'
  ...
  export default {
    ...
    methods:{
        ...
        let { data } = await axios.get(
          "http://121.46.19.26:8511/getGraphByKind/" +
          this.query );
        this.info = data;
        this.key = this.query;
