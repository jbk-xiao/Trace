...
class Category_Model_Train:
    ...
    def train(self, train_data, label, num_classes, batch_size=256, epochs=10, verbose=1, evaluate=True):
        ...
        self.model.fit(x_train, x_test, batch_size, epochs, verbose,
                       validation_split=0.2, callbacks=[EarlyStopping(monitor='val_loss', min_delta=0.0001),
                                                        TensorBoard(log_dir='.\\tmp\\log')])
        plot_model(self.model, to_file='./pic/model.png', show_shapes=True, show_layer_names=False)
    ...
    def plotModel(self):
        ...
        plot_model(self.model, to_file='./pic/model.png', show_shapes=True, show_layer_names=True)
