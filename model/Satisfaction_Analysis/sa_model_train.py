# -*- coding: utf-8 -*-
import pandas as pd
from train import SA_Model_Train
# load conf
from setting import *
import os
...
def model_train():
    # load
    train_data = pd.read_csv('data/label_comment3.csv')
    # process
    ...
    # 模型训练
    model.train(train_data, label, num_classes=2, batch_size=256, epochs=3, verbose=1, evaluate=True)
    print('深度情感分析模型训练完毕')
